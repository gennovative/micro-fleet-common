...
class DatabaseSettings extends Array {
    static fromProvider(provider) {
        let nConn = provider.get(constants_1.DbSettingKeys.DB_NUM_CONN), details = [], d;
    ...
    static buildConnDetails(connIdx, provider) {
        let cnnDetail = {
            clientName: provider.get(constants_1.DbSettingKeys.DB_ENGINE + connIdx) // Must belong to `DbClient`
        }, value;
        // 1st priority: connect to a local file.
        value = provider.get(constants_1.DbSettingKeys.DB_FILE + connIdx);
        if (value) {
            cnnDetail.filePath = value;
            return cnnDetail;
        }
        // 2nd priority: connect with a connection string.
        value = provider.get(constants_1.DbSettingKeys.DB_CONN_STRING + connIdx);
        if (value) {
            cnnDetail.connectionString = value;
            return cnnDetail;
        }
        // Last priority: connect with host credentials.
        value = provider.get(constants_1.DbSettingKeys.DB_HOST + connIdx);
        if (value) {
            cnnDetail.host = {
                address: provider.get(constants_1.DbSettingKeys.DB_HOST + connIdx),
                user: provider.get(constants_1.DbSettingKeys.DB_USER + connIdx),
                password: provider.get(constants_1.DbSettingKeys.DB_PASSWORD + connIdx),
                database: provider.get(constants_1.DbSettingKeys.DB_NAME + connIdx),
            };
            return cnnDetail;
        }
        return null;
    ...
    constructor() {
        ...
        this._countSetting = SettingItem_1.SettingItem.translator.whole({
            name: constants_1.DbSettingKeys.DB_NUM_CONN,
    ...
    pushConnection(detail) {
        ...
        this.push(SettingItem_1.SettingItem.translator.whole({
            name: constants_1.DbSettingKeys.DB_ENGINE + newIdx,
            dataType: SettingItem_1.SettingItemDataType.String,
            value: detail.clientName
        }));
        if (detail.host) {
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_HOST + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
                value: detail.host.address
            }));
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_USER + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
                value: detail.host.user
            }));
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_PASSWORD + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
                value: detail.host.password
            }));
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_NAME + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
            ...
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_FILE + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
            ...
            this.push(SettingItem_1.SettingItem.translator.whole({
                name: constants_1.DbSettingKeys.DB_CONN_STRING + newIdx,
                dataType: SettingItem_1.SettingItemDataType.String,
